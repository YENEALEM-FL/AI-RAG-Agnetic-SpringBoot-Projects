package com.lab.openaiopensearchvectorstore.service;
...
@Service
public class OpenSearchAiService {

    private static final Logger logger = LoggerFactory.getLogger(OpenSearchAiService.class);
